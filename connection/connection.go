...
func openTappConfiguration(fileLocation string) (config Config) {
...
func createClient(config Config) (client *http.Client) {
	/**
...
func Get(configPath string, apiEndpoint string) () {
